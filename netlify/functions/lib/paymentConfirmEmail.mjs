...
function buildPaymentConfirmBodyHtml({ firstName, inv, amt, balance, dateStr, balanceNow }) {
...
export function buildPaymentConfirmEmail({
  ...
  const html = buildBrandedEmailHtml({
    bodyHtml: buildPaymentConfirmBodyHtml({ firstName, inv, amt, balance, dateStr, balanceNow }),
