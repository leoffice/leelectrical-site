...
/**
 * Plain toast when the photo type doesn't match the selected payment method.
 * Returns null when no mismatch / nothing to say.
 */
...
/** Vision kind → Mark-as-paid method label. */
...
/**
 * Map payee / deposit text from ACH screens to a company deposit bank.
 */
